...
<div class="w-full pt-2">
  <div class="flex items-center justify-between w-full">
    <div class="flex ">
    <p class="text-6xl font-bold text-black nunito-">Expenses</p>
    </div>
    ...
    <p class="text-3xl"><i class="ri-add-fill"></i></p>
        <a href="#" onclick="openAddModal()">Add Record</a>
    </button>
  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3 nunito-">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="#" class="ml-1 font-medium text-[#00000080] text-3xl hover:text-blue-600">Employee Expenses</a>
      </div>
    </li>
  </ol>
</nav>
...
<div class="relative inline-block text-center">
    ...
    description: '{{ $record->description ?? 'No description' }}',
                supportingDoc: '{{ $record->supporting_documents }}',
            ...
            View</a></li>
                ...
                <form action="{{ route('expenses.destroy', ['id' => $record->id]) }}" method="POST" class="m-0 p-0">
@csrf
            @method('DELETE')
            <button type="submit" 
  ...
  <div id="modal-container" class="w-1/3 flex flex-col justify-start items-center relative bg-white nunito- p-2 rounded-3xl bg-gradient-to-r from-[#184E77] to-[#52B69A]">
    ...
    <div class="w-full flex flex-col justify-start items-center bg-white p-8 rounded-3xl space-y-8">
      <div class="flex flex-col justify-center items-center space-y-4">
        <p class="text-5xl text-black font-bold">Expense record</p>
        ...
        <div class="w-full flex mx-auto pb-8 pt-8 px-16">
            ...
            <p class="text-xl font-bold text-black">Expense Category :</p>
            <p class="text-xl font-bold text-black">Amount :</p>
...
<p class="text-xl font-bold text-black modal-expense-type"></p>
<p class="text-xl font-bold text-black modal-expense-amount"></p>
...
function openEditModal(incidentId) {
    ...
    fetch(`http://127.0.0.1:8000/dashboard/expenses/${incidentId}/edit`)
...
function openViewModal(data) {
    ...
    document.querySelector('#view-attendance-modal-container .modal-expense-type').textContent = data.category;
    document.querySelector('#view-attendance-modal-container .modal-expense-amount').textContent = data.amount;
    document.querySelector('#view-attendance-modal-container .modal-approved-by').textContent = data.approved_by;
