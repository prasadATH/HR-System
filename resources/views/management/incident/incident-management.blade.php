...
<div class="modal fade" id="editAttendanceModal" tabindex="-1" aria-hidden="true" data-bs-keyboard="false">
    ...
    <div class="w-full pt-2">
      <div class="flex items-center justify-between w-full">
        <div class="flex ">
        <p class="md:text-6xl text-4xl font-bold text-black nunito-">Incidents</p>
        </div>
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3 nunito-">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="#" class="ml-1 font-medium text-[#00000080] text-3xl hover:text-blue-600">Employee Incidents</a>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <table class="w-full nunito- border-separate" style="border-spacing: 0 12px; width: 100%;" id="attendance-table">
      <thead class="w-full">
        ...
        <th class="text-xl text-black font-bold px-4 py-2 text-left align-middle">Employee</th>
          <th class="text-xl text-black font-bold px-4 py-2 text-left align-middle">Type of Incident</th>
          <th class="text-xl text-black font-bold px-4 py-2 text-left align-middle">Date of Incident</th>
      ...
      @if (strtolower($record->resolution_status ) === 'resolved')
    
    <p class="text-[#47B439] border-2 border-[#47B439] bg-[#47B43933] rounded-xl px-2 py-1 shadow-sm">
        Resolved 
    </p>
    @elseif (strtolower($record->resolution_status ) === 'pending')
