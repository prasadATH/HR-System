...
@section('content')
<form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" class="flex flex-col items-start justify-start w-full px-16">
    @csrf
    @method('PUT')
...
<div class="w-full pt-8 nunito- px-16">
