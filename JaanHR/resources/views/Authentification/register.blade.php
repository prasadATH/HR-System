        ...
        <div class="w-1/2">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                    ...
                    <label for="remember" class="ml-2 block text-gray-700 nunito- ">By Creating account, you are accepting <span class="bg-gradient-to-r from-[#184E77] via-[#52B69A] to-[#184E77] bg-clip-text text-transparent font-bold cursor-pointer">terms & conditions</span></label>
                </div>
            ...
            <div class="w-full pt-8">
                <p class="text-xl">Already have an account? <span class="bg-gradient-to-r from-[#184E77] via-[#52B69A] to-[#184E77] bg-clip-text text-transparent font-bold cursor-pointer">      <a href="{{ route('login.form') }}" class="bg-gradient-to-r from-[#184E77] via-[#52B69A] to-[#184E77] bg-clip-text text-transparent font-bold cursor-pointer">
                Login
            </a></span></p>
            </div>
